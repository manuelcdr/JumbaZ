...
namespace Chamada.Services.Api30.Controllers
{
    ...
    public class GenericController : ControllerBase
    {
        ...
        public IActionResult Get(string objectName)
        {
            ...
            var models = entidades.Select(x => mapper.Map(x, _typer.CurrentTyper, tipoModel));

            //var models = mapper.Map(entidades, entidades.GetType(), tipoModel);
        ...
        [HttpPost("{objectName}")]
        public IActionResult Post(string objectName, [FromBody] object jsonValues)
        {
            ModelState.Clear();
